...
![image-20230428220309910](image-20230428220309910.png)

**点击“Create”**

![image-20230428220322308](image-20230428220322308.png)

**删除src目录**

（2）构建子模块spring6-first

![image-20230428220347054](image-20230428220347054.png)

点击 Create 完成

![image-20230428220357592](image-20230428220357592.png)
...
![image-20230428220445728](image-20230428220445728.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!--
    配置 HelloWorld 所对应的 bean ，即将 HelloWorld 类对象交给 Spring 的 IOC 容器管理
...
![image-20230428220658690](image-20230428220658690.png)
...
Spring 容器加载到 Bean 类时,会把这个类的描述信息, 以包名加类名的方式存到 **beanDefinitionMap**
中, 其中 String 是 Key , 默认是类名首字母小写, **BeanDefinition**, 存的是类的定义(描述信息) , 我们通常叫BeanDefinition 接口为 : bean 的定义对象。
